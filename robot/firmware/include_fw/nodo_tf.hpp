...
sstring topicoControlNodo = "control_nodos";


double SEC_NO_CONTROL = 2; //Segundos sin control
double ESPERA_HZ = 5; //Frecuencia de espera (para no dejarlo solo)
...
public:
     ...
     */
    virtual void emergencyCallback(const ros::WallTimerEvent& evnt);
...
void NodoTF::init(int argc, char **argv)
{
    ...
    */
    ...
    activarTimerEmergencia(SEC_NO_CONTROL);
